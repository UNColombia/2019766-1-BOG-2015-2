 ...
 *
 * <p>Description: Algorithm operator that modifies the individuals generated by other
...
public class RefiningOperator<G> extends Operator<G>{
         ...
         * @param refined Algorithm operator to be refined
         * @param refining Algorithm operator refining the individuals produced by the refined operator
         */
         ...
         * Constructor: Creates a refining genetic operator with the given operators
         * @param refined Algorithm operator to be refined
         * @param refining Algorithm operators refining the individuals produced by the refined operator
         */
        public RefiningOperator( Operator<G> refined, ArityOne<G>[] refining) {
            this.refined = refined;
