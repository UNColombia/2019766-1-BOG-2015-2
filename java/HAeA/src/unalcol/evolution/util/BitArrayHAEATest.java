...
import unalcol.types.types.collection.bitarray.BitArray;
import unalcol.types.types.collection.bitarray.BitArrayInstance;
...
public class BitArrayHAEATest {
    public static void main( String[] args ){
        ...
        InstanceService ikey = (InstanceService) new BitArrayInstance();
        ...
        // Algorithm Algorithm Transformation
