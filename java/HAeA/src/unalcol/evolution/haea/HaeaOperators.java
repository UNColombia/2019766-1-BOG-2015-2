...
public abstract class HaeaOperators<T>{
     ...
     * @return Algorithm operator associated to the given index and individual
     */
    public abstract Operator<T> get( int indIndex, int operIndex );

    /**
     * Algorithm operator reward mechanism
    ...
    /**
     * Algorithm operator punish mechanism
     * @param r Rates associated to an individual
    ...
    /**
     * Algorithm operator rates associated to a given individual
     * @param indIndex Individual
     * @return Algorithm operator rates associated to a given individual
     */
    ...
    /**
     * Algorithm operator rates
     * @return Algorithm operator rates
     */
