...
public class SimpleHaeaOperators<T> extends HaeaOperators<T>{
    /**
     * Algorithm operator to be used by each individual
     */
    protected Operator<T>[] opers;

    /**
     * Creates a simple hAEA Operators manager
     * @param opers Algorithm operator to be used by HAEA
     */
     ...
     * @return Algorithm operator associated to the given index
     */
